...
try:
    ...
    _logger.info("SIT Modulo constants [rrhh_base_sv_dte-hr_payslip]")
...
class HrPayslip(models.Model):
    ...
    def action_send_payslip_email(self):
        ...
        template = self.env.ref('rrhh_base_sv_dte.rrhh_email_template_payslip', raise_if_not_found=False)
        if not template:
        ...
        report_action = (self.env.ref('rrhh_base_sv_dte.hr_payslip_report', raise_if_not_found=False)
                         or self.env.ref('rrhh_base_sv_dte.report_payslip', raise_if_not_found=False))
