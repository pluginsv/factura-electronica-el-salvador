...
try:
    ...
    _logger.info("SIT Modulo common_utils_sv_dte [Asignaciones -payslip]")
except ImportError as e:
    _logger.error(f"Error al importar 'common_utils_sv_dte': {e}")
    constants = None
    ...
    def _agregar_asignaciones_salario(self):
        ...
        for slip in self:
            ...
            for tipo in tipos_asignacion_final:
                ...
                # input_type = self.env.ref(f'hr_asignaciones_sv_dte.{xml_id}', raise_if_not_found=False)
