...
class DispatchRoute(models.Model):
    ...
    def _check_max_assistants(self):
        ...
        if not config_utils:
            raise ValidationError(_("Falta el módulo/common_utils_sv_dte (config_utils). Verifica addons_path e instalación."))
    ...
    def action_download_report_reception(self):
        ...
        return self.env.ref('despacho_sv_dte.action_report_recepcion_ruta').report_action(ruta)
    ...
    def action_download_report_cargar_ruta(self):
        ...
        return self.env.ref('despacho_sv_dte.action_report_carga_ruta').report_action(ruta)
    ...
    def action_download_loading_routes_report(self):
        ...
        return self.env.ref('despacho_sv_dte.action_report_montacarguista').report_action(routes)
