...
export class MapDistrictsComponent extends Component {
  static template = "despacho_sv_dte.MapContainer";
  ...
  _initMap() {
    ...
    this.districtsLayer.loadGeoJson("/despacho_sv_dte/static/data/slv_admin2_em.geojson", null, () => {
    ...
    this.previousLayer.loadGeoJson("/despacho_sv_dte/static/data/geoBoundaries-SLV-ADM2.geojson", null, () => {
      this._applyStyles(this.props);
    });
  }
