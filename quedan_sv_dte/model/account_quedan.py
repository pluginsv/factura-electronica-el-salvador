...
#   - Reporte QWeb 'quedan_sv_dte.report_quedan_documento'.
#   - Plantilla email 'quedan_sv_dte.email_template_quedan'.
# ------------------------------------------------------------
...
class AccountQuedan(models.Model):
    ...
    def download_quedan(self):
        ...
        return self.env.ref("quedan_sv_dte.report_quedan_documento").report_action(self)
    ...
    def action_send_email(self):
        ...
        template = self.env.ref('quedan_sv_dte.email_template_quedan', raise_if_not_found=False)
        if not template:
        ...
        # ----- Render PDF -----
        report = self.env.ref('quedan_sv_dte.report_quedan_documento', raise_if_not_found=False)
