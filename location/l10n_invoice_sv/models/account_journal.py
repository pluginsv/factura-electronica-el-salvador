...
class Journal(models.Model):
    ...
    type_report = fields.Selection([
        ...
        ('ndc', 'Nota de Credito'),
        ('anu', 'Anulacion'),
        ('axp', 'Anulacion de Exportacion'),
        ('cse', 'Compra a Sujetos Excluidos'),
        ('imp', 'Importaciones'),
        ('compras', 'CCF Compras'),
        ('na', 'No Aplica'),
        ('anu_compras', 'Reintegro de CCF Compras'),
        ('ndd', 'Nota de Debito'),
    ], default=False,string='Tipo de Documento Fiscal',copy=False,
        help="El 'Tipo de Documento Fiscal' es usado en "\
    ...
    report_xml = fields.Many2one('ir.actions.report', 'Reporte Xml')